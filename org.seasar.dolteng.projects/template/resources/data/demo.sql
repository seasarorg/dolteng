CREATE TABLE EMP(ID NUMERIC(8,0) IDENTITY NOT NULL PRIMARY KEY, EMP_NO NUMERIC(4,0) NOT NULL ,EMP_NAME VARCHAR(20),MGR_ID NUMERIC(8,0),HIREDATE DATE,SAL NUMERIC(7,2),DEPT_ID NUMERIC(8,0), VERSION_NO NUMERIC(8));
